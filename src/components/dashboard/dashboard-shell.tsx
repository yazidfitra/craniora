    ...
    <>
      ...
      <header className="bg-white border-b border-slate-200 shadow-sm sticky top-0 z-40 flex justify-between items-center w-full px-4 h-16 lg:hidden">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full overflow-hidden border border-primary-50 bg-primary-400 flex items-center justify-center">
            {avatarUrl ? (
              <Image
                src={avatarUrl}
          ...
          <span className="text-xl font-bold text-primary-container font-[var(--font-heading)]">
            Craniora Academy
          </span>
        </div>
        <div className="flex items-center gap-2">
          ...
          <button className="p-2 rounded-full hover:bg-slate-50 transition-colors text-primary-container relative">
      ...
      {/* ===== MAIN CONTENT ===== */}
      <div
        className="pb-24 lg:pb-8 transition-all duration-300"
        style={{
